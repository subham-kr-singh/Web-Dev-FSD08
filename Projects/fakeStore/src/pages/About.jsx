  ...
  return (
    <>
      <div className="flex flex-col items-center bg-stone-100 gap-5 p-10">
        ...
        <div className="flex justify-center w-250 p-10 gap-4">
          ...
          <div className="w-1/2 bg-white shadow rounded-2xl"></div>
        </div>

        <div className="flex *:rounded-2xl gap-5 *:h-fit *:w-120 *:bg-white *:[&_span]:text-3xl *:[&_span]:font-bold *:[&_p]:text-xl *:[&_p]:font-medium *:[&_div]:flex *:[&_div]:flex-col *:[&_div]:items-start *:[&_div]:justify-center *:[&_div]:gap-3 *:[&_div]:p-5 *:shadow">
          <div className="">
            <img
              src=""
              alt=""
